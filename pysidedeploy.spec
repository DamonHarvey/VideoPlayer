...
# python path
python_path = C:\Programming\github\VideoPlayer\.venv\Scripts\python.exe
...
modules = Core,Gui,Multimedia,MultimediaWidgets,Network,Widgets
...
extra_args = --quiet --noinclude-qt-translations --windows-console-mode=disable --include-data-dir=assets=assets
